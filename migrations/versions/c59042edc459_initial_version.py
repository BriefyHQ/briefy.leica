...
def upgrade():
    ...
    sa.Column('currency_set_price', sqlalchemy_utils.types.currency.CurrencyType(length=3),
              nullable=True),
    ...
    sa.Column('category', sqlalchemy_utils.types.choice.ChoiceType(types.CategoryChoices),
              nullable=True),
    ...
    sa.Column('client_job_status', sqlalchemy_utils.types.choice.ChoiceType(
        types.ClientJobStatusChoices), nullable=True),
    ...
    sa.Column('currency_payout', sqlalchemy_utils.types.currency.CurrencyType(length=3),
              nullable=True),
    ...
    sa.Column('scheduling_issues', sqlalchemy_utils.types.choice.ChoiceType(
        types.SchedulingIssuesChoices), nullable=True),
    ...
    sa.Column('title', sa.String(length=255), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('asset_url', sqlalchemy_utils.types.url.URLType(), nullable=True),
